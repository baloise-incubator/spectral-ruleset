...
| --- | --- | --- | --- | --- |
| [#100][#100] | [MUST follow API first principle][#100] | - | - | B |
...
| [#108][#108] | [MUST prepare clients accept compatible API extensions][#108] | - | - | C |
...
| [#141][#141] | [MUST keep URLs verb-free][#141] | - | - | A |
...
| [#150][#150] | [MUST use standard HTTP status codes][#150] | :heavy_check_mark: | :heavy_check_mark: | - | - |
...
| [#191][#191] | [MUST not start using deprecated APIs][#191] | - | - | B |
| [#192][#192] | [MUST publish Open API specification][#192] | - | - | A |
...
| [#228][#228] | [MUST use URL-friendly resource identifiers: [a-zA-Z0-9:._\-/]*][#228] | - | - | A |
